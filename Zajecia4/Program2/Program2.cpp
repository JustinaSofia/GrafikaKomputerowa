...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("big_perfect_grass_prospective_projection_map.tga", width, height, format, type, pixels);
	...
	error = load_targa("cherry_tree_blossom.tga", width, height, format, type, pixels);
